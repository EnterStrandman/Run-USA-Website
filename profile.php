...
<div class="container">
	<div class="col-md-4">
		<img src="https://avatarfiles.alphacoders.com/742/74290.jpg" id = "profilePic" alt="Profile Picture">
	</div>
</div>
			...
			<!-- Collect the nav links, forms, and other content for toggling -->
					...
					<ul class="nav navbar-nav navbar-left">
						<div class = "col-sm-12 col-xs-9" style ="color: rgba(0, 153, 255,.6)";">
						    <li>E-Mail Us At:<a href="mailto:runUSA@runUSA.com"> runUSA@runUSA.com</a></li>
